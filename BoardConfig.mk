...
### REASON: TOUCH SYNAPTIC SUCKS
TW_NO_SCREEN_TIMEOUT := true
### REASON: FASTBOOT IS BROKEN AND THUS BOOTLOADER ISNT NEEDED
TW_NO_REBOOT_BOOTLOADER := true
### REASON: YEET BACK TO DWLDMDE
TW_HAS_DOWNLOAD_MODE := true
### REASON: f2fs is a staple thing for samsung
TARGET_USERIMAGES_USE_F2FS := true
### REASON: IDENTIFIER
TW_DEVICE_VERSION := 3.12-1_twrp_SUFandom
### REASON: MTP
TW_MTP_DEVICE := "Galaxy A12s TWRPMTP"
### REASON: DISPLAY
TARGET_SCREEN_WIDTH := 720
TARGET_SCREEN_HEIGHT := 1600
### REASON: ERR, ADD SUPPORT ON NTFS?
