...
## WHAT HAYATE TOLD ME : DISABLE THESE AND ENABLE THE TOP WHEN DOING PBRP 11
#TARGET_PREBUILT_KERNEL := $(DEVICE_PATH)/prebuilt/kernel
#TARGET_PREBUILT_DTB := $(DEVICE_PATH)/prebuilt/dtb
#BOARD_PREBUILT_DTBOIMAGE := $(DEVICE_PATH)/prebuilt/dtbo
#BOARD_INCLUDE_DTB_IN_BOOTIMG := true
...
TW_DEVICE_VERSION := A12s_UA_v1.1-PB_SUFandom
...
TW_EXCLUDE_TWRPAPP := true # REMOVE TWRPAPP IF THERE's ANY
...
PB_GO := TRUE # ENABLE THIS TO AVOID OVERLAPPING TO 55MB

# TRY TO NOT INCLUDE SDCARD
